...
def update_q_table(_q_table, state, reward, player_id):
    ...
    for x in it:
        ...
        if x == 0:
            ...
            current_q_values[it.multi_index] += alpha*(reward + gamma * np.nanmax(next_q_values) - current_q_values[it.multi_index])
        else:
...
if __name__ == '__main__':
    ...
    for i in range(n_games):
        ...
        #print('Table 1 ', q_table1)
        #print('Table 2', q_table2)
